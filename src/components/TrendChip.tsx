...
export default function TrendChip({
  ...
  return (
    <span
      className={`inline-flex items-center h-[24px] px-[7px] py-[1px] rounded-full text-[12px] font-medium leading-[18px] font-['Inter',sans-serif] transition-colors duration-200 ${className}`}
      style={{
