 ...
 * Maps/Areas use for their own overlay swap), so dragging the slider is
...
export default function AssetsView({ area, range }: { area: Area; range: DateRange }) {
  ...
  // Same bucket math MapsView/AreasView use to pick which aerial photo the
  ...
  return (
    <div className="view-enter px-4 pb-6 flex flex-col gap-[14px]">
      <div className="flex items-center justify-between gap-2 py-[10px]">
        <div>
          <h2 className="text-[14px] font-bold text-[#18181c] leading-[22px] font-['Outfit',sans-serif]">Assets</h2>
